...
exports.getMessInfo = async (req, res) => {
    try {
      ...
      mess.sort(compare);
      return res.render("admin/mess/index", { mess });
    } catch (error) {
  ...
  exports.addMessForm = async (req, res) => {
    try {
      ...
      return res.render("admin/mess/add");
    } catch (error) {
      console.log(error.message);
    }
  };
  ...
  exports.postMess = async (req, res) => {
    try {
      ...
      if (!path) {
        ...
        return res.redirect("/admin/mess/add");
      }
      //console.log(path);
...
exports.getMessEditForm = async (req, res) => {
    try {
      ...
      return res.render("admin/mess/edit", { mess});
    } catch (error) {
      console.log(error.message);
    }
  };
